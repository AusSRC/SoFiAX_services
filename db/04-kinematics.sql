...
CREATE TABLE wallaby.kinematic_model_3kidnas (
  ...
  "rhi_as" double precision NOT NULL,
  "rhi_low_as" double precision NOT NULL,
  "rhi_high_as" double precision NOT NULL,
  "dist_model" double precision NOT NULL,
  "rhi_kpc" double precision NOT NULL,
  "rhi_low_kpc" double precision NOT NULL,
  "rhi_high_kpc" double precision NOT NULL,
  "vhi_flag" integer NOT NULL,
  "vhi" double precision NOT NULL,
  "e_vhi" double precision NOT NULL,
