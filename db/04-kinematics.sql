...
CREATE TABLE wallaby.kinematic_model_3kidnas (
  ...
  "team_release" varchar NOT NULL,
  "team_release_kin" varchar NOT NULL,
  "rms_model" double precision NOT NULL,
  "sn_integrated_model" double precision NOT NULL,
  "sn_peak_model" double precision NOT NULL,
  "sn_average_model" double precision NOT NULL,
  "sn_median_model" double precision NOT NULL,
  "vsys_model" double precision NOT NULL,
  "e_vsys_model" double precision NOT NULL,
  "x_model" double precision NOT NULL,
  "e_x_model" double precision NOT NULL,
  ...
  "rhi_as" double precision NULL,
  "rhi_low_as" double precision NULL,
  "rhi_high_as" double precision NULL,
  "dist_model" double precision NOT NULL,
  "rhi_kpc" double precision NULL,
  "rhi_low_kpc" double precision NULL,
  "rhi_high_kpc" double precision NULL,
  "vhi_flag" integer NOT NULL,
  "vhi" double precision  NULL,
  "e_vhi" double precision  NULL,
